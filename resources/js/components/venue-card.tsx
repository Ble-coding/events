...
const VenueCard = ({
  ...
  return (
    <div className="bg-white dark:bg-guilo-black/60 rounded-xl overflow-hidden shadow-lg card-hover h-full flex flex-col">
      <div className="relative h-48">
        ...
        {/* Badge Capacité */}
        <div className="absolute top-4 left-4 bg-white dark:bg-guilo-black rounded-lg px-3 py-1.5 text-sm font-medium flex items-center">
